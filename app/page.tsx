    ...
    <div className="page-wrapper">
      <style jsx global>{`
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* --- STACKING CARDS (PC İÇİN ORİJİNAL AYARLAR) --- */
        .section-card { 
        ...
        /* Glass efektini (Buzlu cam) geri getirdik */
        ...
        .card-footer { background: rgba(0, 0, 0, 0.8); backdrop-filter: blur(40px); border-top: 1px solid rgba(255,255,255,0.05); z-index: 30; min-height: 60vh; border-radius: 60px 60px 0 0; position: relative; }
        ...
        .nav-link { font-weight: bold; opacity: 0.8; cursor: pointer; transition: 0.3s; font-size: 1rem; border-bottom: 2px solid transparent; }
        .nav-link:hover { opacity: 1; border-color: white; }

        .premium-badge { background: linear-gradient(45deg, #FFD700, #FFA500); color: black; padding: 5px 15px; border-radius: 20px; font-weight: 900; cursor: pointer; transition: 0.3s; font-size: 0.9rem; }
        .premium-badge:hover { transform: scale(1.1); box-shadow: 0 0 25px rgba(255, 215, 0, 0.8); }
        .login-btn { background: rgba(255,255,255,0.1); border: 1px solid rgba(255,255,255,0.3); padding: 10px 25px; border-radius: 50px; font-weight: 800; cursor: pointer; transition: 0.3s; color: white; backdrop-filter: blur(10px); }
        .login-btn:hover { background: white; color: #0055FF; }
        
        /* --- İÇERİK DÜZENİ (PC İÇİN YAN YANA) --- */
        .content-container { 
            max-width: 1200px; width: 90%; margin: 0 auto; 
            display: flex; flex-wrap: wrap; align-items: center; justify-content: center; gap: 50px; 
        ...
        /* --- MOBILE İÇİN ÖZEL AYARLAR (BURASI SİHİRLİ KISIM) --- */
        @media (max-width: 768px) {
            ...
            .content-container { flex-direction: column; text-align: center; gap: 30px; }
            
            .card-hero { justify-content: flex-start; padding-top: 130px; } /* Mobilde üstten biraz daha boşluk */
            .roket { font-size: 120px; order: -1; margin-bottom: 20px; } /* Mobilde roket üstte */
            
            .pricing-grid { grid-template-columns: 1fr !important; } /* Fiyatlar alt alta */
            .glass-modal { padding: 25px !important; width: 95% !important; }
            
            .section-card { min-height: auto; padding: 40px 20px; } /* Mobilde sticky'i biraz rahatlattık */
        }

        .input-box { background: rgba(255,255,255,0.15); border: 2px solid rgba(255,255,255,0.2); color: white; padding: 20px; width: 100%; border-radius: 16px; font-size: 1.2rem; font-weight: bold; margin-bottom: 20px; }
        .input-box:focus { background: rgba(255,255,255,0.25); border-color: white; }
        .btn-premium { background: #FFD700; color: black; font-weight: 900; font-size: 1.2rem; padding: 20px; width: 100%; border-radius: 16px; text-transform: uppercase; letter-spacing: 1px; box-shadow: 0px 6px 0px 0px #b8860b, 0px 15px 20px rgba(0,0,0,0.2); transition: all 0.1s; cursor: pointer; }
        ...
        .price-card { background: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.1); padding: 25px; border-radius: 20px; transition: 0.3s; position: relative; overflow: hidden; display: flex; flex-direction: column; justify-content: space-between; }
        ...
        <div className="content-container">
          ...
          <div style={{flex: 1, display: 'flex', justifyContent: 'center', alignItems: 'center', height: '400px', position: 'relative'}}>
             ...
             <div style={{zIndex: 10, transition: 'all 0.5s'}}>
               {sonuc ? <span style={{fontSize: '200px', display: 'block'}}>🔥</span> : <span className={`roket ${loading ? 'roket-shaking' : ''}`}>🚀</span>}
             </div>
          </div>
        </div>
