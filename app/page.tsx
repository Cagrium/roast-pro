    ...
    <div className="page-wrapper">
      <style jsx global>{`
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* --- STACKING CARDS (ESKİ ORJİNAL EFEKT) --- */
        .section-card { 
      ...
      <section className="section-card card-footer">
         <div className="footer-grid">
            <div className="footer-col">
                <h4 style={{fontSize:'1.8rem', color:'#FFD700'}}>RoastAI Inc.</h4>
                <p style={{opacity:0.5, fontSize:'0.9rem'}}>© 2026</p>
            </div>
            <div className="footer-col">
                <h4>Yasal</h4>
                <a onClick={() => metinAc("Kullanım Şartları")}>Kullanım Şartları</a>
                <a onClick={() => metinAc("Gizlilik Politikası")}>Gizlilik</a>
            </div>
            <div className="footer-col">
                <h4>İletişim</h4>
                <a href="https://x.com/cagrium" style={{color:'white', fontSize:'0.9rem'}}>@cagrium</a>
            </div>
         </div>
      </section>
